...
export default function ViewPublicTeam() {
  ...
  return (
    <>
      ...
      <div className="creator-details">Created by: {teamDetails.creator_name}</div>
      ...
      <div className="members-content-container">
        {filteredItems.map((member) => (
          <PublicMemberCard key={member.firebaseKey} memberObj={member} onUpdate={displayTeamMembers} />
        ))}
      </div>
